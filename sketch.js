...
function setup(){
  ...
  finishLine = createSprite(20000,420,20,20);
  finishLine.addImage("finish",finishLineI);
  finishLine.scale = 0.4
  // finishLine.debug = true;
  finishLine.setCollider("rectangle",0,0,525,10080);
...
function draw(){
  ...
  if(gameState === 0){
    ...
    text("And UP ARROW to jump",canvasW/2-200,canvasH/2+100)
      ...
      finishLine.velocityX = -(player.body.velocityX);
      ...
      if(player.body.isTouching(finishLine)){
        gameState = 2;
      }
